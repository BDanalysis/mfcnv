...
bam = "/media/huangtihao/Huang Tihao/data/lcdx/1000genomes/chr21/NA19238.chrom21.SLX.maq.SRP000032.2009_07.bam";
binSize = 1000
...
myin = open('/media/huangtihao/Huang Tihao/data/lcdx/1000genomes/NA19238.txt','r')
line = myin.readline()
list1 = []
while line :
    a = line.split()
...
samfile=pysam.AlignmentFile("/media/huangtihao/Huang Tihao/data/lcdx/1000genomes/chr21/NA19238.chrom21.SLX.maq.SRP000032.2009_07.bam", "rb")
map_q = []
pos_q = []
for r in samfile:
    map_q.append(r.mapq)
...
myOut2 = open('/media/huangtihao/Huang Tihao/data/lcdx/1000genomes/NA19238_trains.txt','w')
